...
namespace TIC_TAC_TOE
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            welcomeTimer.Interval = 2000; // 3 seconds for the welcome message
            ...
            resetTimer.Interval = 2000; // 2 seconds delay
        ...
        private void FinishGame(object sender, EventArgs e)
        {
            ...
            closeTimer.Interval = 2000; // 3000 milisegundos = 3 segundos
